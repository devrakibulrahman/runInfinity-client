        ...
        <>
            <div className="w-full">
                ...
                <div className="w-full relative my-5">
                    <div className="w-full min-h-[2px] bg-gray-600/20"></div>
                    <div className="w-4 h-4 bg-orange-400 rounded-full absolute top-[50%] right-0 transform -translate-y-[50%]"></div>
                </div>
                <div className="w-full">
                    <h1 className="poppins text-3xl text-black font-bold transition-all ease-linear duration-300 md:text-[40px] xl:text-[48px]">{heading}</h1>
                </div>
            </div>
        </>
    );
