            ...
            <div className="w-full">
                <form className="w-full">
                    ...
                    <div className="w-full flex justify-end">
                        <p className="poppins text-sm text-gray-500 transition-ease-linear hover:underline cursor-pointer">Forget Password?</p>
                    </div>
                    <div className="w-full mt-5">
                        <button className="popping text-base font-medium uppercase tracking-wider text-white cursor-pointer bg-gradient-to-r from-orange-400 to-orange-500 w-full px-5 py-3 transition-ease-linear hover:from-orange-500 hover:to-orange-400">Login</button>
                    </div>
