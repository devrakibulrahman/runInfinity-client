    ...
    return (
        <>
            <div className="w-full min-h-[400px] bg-[url(/img/marathon.jpg)] bg-fit relative">
                <div className="w-full h-full absolute top-0 left-0 bg-gradient-to-b from-transparent to-black/90">
                    <div className="w-full p-5 absolute left-0 bottom-0">
                        ...
                        <div className="w-full flex items-center gap-5 mt-2 lg:flex-col lg:items-start lg:gap-2">
                            ...
                            <div className="w-auto flex items-center gap-2">
                                <h3 className="poppins text-sm font-semibold text-orange-400 lg:text-base">Reg. Start Date:</h3>
                                <p className="poppins text-sm font-medium text-white lg:text-base">Feb 10, 2025</p>
                            </div>
                            <div className="w-auto flex items-center gap-2">
                                <h3 className="poppins text-sm font-semibold text-orange-400 lg:text-base">Reg. End Date:</h3>
                                <p className="poppins text-sm font-medium text-white lg:text-base">Feb 10, 2025</p>
                            </div>
                        </div>
